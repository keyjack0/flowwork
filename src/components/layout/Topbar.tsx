...
export default function Topbar({ title, action }: TopbarProps) {
  ...
  return (
    <div className="bg-white border-b border-gray-100 px-6 h-14 flex items-center gap-3 flex-shrink-0">
      ...
      <div className="flex items-center gap-2">
        ...
        {action && (
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 text-[12px] font-medium bg-[#685AFF] text-white rounded-lg hover:bg-[#4A3FCC] transition-colors"
          >
            {action.icon}
            {action.label}
          </button>
